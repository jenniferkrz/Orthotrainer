        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                if (result.debug) {
                    ...
                    console.log("gruppe:", result.debug.gruppe);
                    console.log("identifier_original:", result.debug.identifier_original);
                    console.log("identifier_clean:", result.debug.identifier_clean);
                    console.log("==================");
                    data = result.data;
                }
                ...
                if (data && Array.isArray(data)) {
                    ...
                    console.warn("Keine Winkelwerte gefunden oder ungültiges Format");
                }
            },

$(document).ready(function () {
    ...
    // ====================================================================
    // KORRIGIERTE KOORDINATENBERECHNUNG - FIREFOX-KOMPATIBEL
    // ====================================================================

    /**
     * Berechnet die Canvas-Koordinaten aus Client-Koordinaten (Maus oder Touch)
     * Verwendet getBoundingClientRect() des Bildes für Browser-unabhängige Berechnung
     */
    function getCanvasCoordinates(clientX, clientY) {
        // getBoundingClientRect() liefert die tatsächlich gerenderte Position und Größe
        // inklusive aller CSS-Transformationen (translate, scale)
        const imgRect = img.getBoundingClientRect();

        // Position relativ zum transformierten Bild
        const mouseXInImg = clientX - imgRect.left;
        const mouseYInImg = clientY - imgRect.top;

        // imgRect.width/height enthält die tatsächlich gerenderte Größe (inkl. Zoom)
        // Skaliere auf Canvas-Koordinaten (natürliche Bildgröße)
        const scaleX = canvas.width / imgRect.width;
        const scaleY = canvas.height / imgRect.height;

        return {
            x: mouseXInImg * scaleX,
            y: mouseYInImg * scaleY
        };
    }

$(document).ready(function () {
    ...
    function summen1(){
        ...
        document.getElementById('editsum1').value = summe.toFixed(2);
    }
    ...
    function summen2(){
        ...
        document.getElementById('editsum2').value = summe.toFixed(2);
    }
    ...
    function summen3(){
        ...
        document.getElementById('editsum3').value = summe.toFixed(2);
    }
